...
class YOLO(object):
    ...
    def train(self, train_imgs,  # the list of images to train the model
              ...
              optimizer_config,
              mosaic='none',
              saved_pickles_path='/src/datafiles/yolo/pickles',
              saved_weights_name='/src/datafiles/yolo/saved_weights/best_model_bestLoss.h5',
              workers=3,
              max_queue_size=8,
              early_stop=True,
              tb_logdir="./",
        ...
        # ckp_best_loss = ModelCheckpoint("/src/datafiles/yolo/saved_weights/benchmark_weights/model",
        #                                 monitor='val_loss',
        #                                 verbose=1,
        #                                 save_best_only=True,
        #                                 mode='min',
