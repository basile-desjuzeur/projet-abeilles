...
argparser.add_argument(
    '-c',
    '--conf',
    default='/src/datafiles/yolo/configs/benchmark_configbees_detection_mobilenet_retrain_find_lrjson',
...
def _main_(args):   
    ...
    now=datetime.now()
    plt.savefig('/src/datafiles/yolo/outputs/lr_finder_on_{}_.png'.format(now.strftime("%d_%m_%Y_%H_%M")))
